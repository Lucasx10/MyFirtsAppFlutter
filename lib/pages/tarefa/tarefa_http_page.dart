...
import 'package:myfirstappflutter/repositories/back4app/tarefas_back4app_repository.dart';
                ...
                builder: (BuildContext bc) {
                  return AlertDialog(
                    ...
                    actions: [
                      ...
                      TextButton(
                        onPressed: () async {
                          await tarefaRepository.criar(TarefaBack4AppModel.criar(descricaoControler.text, false));
                          Navigator.pop(context);
                          obterTarefas();
                          setState(() {});
                        },
